 ...
 * @author dell
 */
public class dosyaSec extends javax.swing.JFrame {

    static String filePath;
    static String skullaniciAdi;
    ...
    private void initComponents() {
        ...
        dosyaSec.setText("Dosya Sec ve Oyuna Basla");
        ...
        kullaniciAdiLabel.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        kullaniciAdiLabel.setText("Kullanici Adinizi Giriniz");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(kullaniciAdiLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(97, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(dosyaSec, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void dosyaSecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dosyaSecActionPerformed
        ...
        fileChooser.setDialogTitle("Lütfen bir resim dosyasi seciniz.");
        fileChooser.setAcceptAllFileFilterUsed(false);
        FileNameExtensionFilter filter = new FileNameExtensionFilter("resim dosyasi", "png", "jpg", "jpeg");
	fileChooser.addChoosableFileFilter(filter);
        ...
        if ((filePath != null)) {
            if (kullaniciAdi.getText().length() == 0) {
                JOptionPane.showMessageDialog(null, "Kullanici Adi Oluşturnuz.", "UYARI", JOptionPane.ERROR_MESSAGE);
            } else {
                skullaniciAdi = kullaniciAdi.getText();
                puzzleAna anaS = new puzzleAna();
                anaS.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dosyaSec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
